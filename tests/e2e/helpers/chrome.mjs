...
<body>
  <nav><a href="/octocat/Hello-World/pulls" id="nav-pr">Pull requests</a>
       <a href="/octocat/Hello-World/issues" id="nav-issues">Issues</a></nav>
  <p id="prose">Create a branch, open a pull request, and ask for a review.</p>
  <pre id="code"><code>git push --force origin main</code></pre>
  <textarea id="draft">書きかけ</textarea>
</body></html>`;
